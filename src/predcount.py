...
try:
    from alpha_exact import alpha_from_cb_edges, k3_bearing_edges
...
def main():
    ...
    print("  * theory predicts speedup = Theta((m/alpha)^{rho-1}) = Theta(sqrt(m)/alpha)")
    print("    for K3, i.e. speedup exponent b and alpha exponent a satisfy")
    print("    b = (rho-1)(1-a) = 0.5(1-a). When alpha is constant (a~0) the whole")
    print("    0.5 appears in b; when alpha grows, b falls accordingly. (The two")
    print("    exponents do NOT simply sum to 0.5 unless a~0.)")
